      ...
      <ul class="navbar-nav align-items-center ml-auto ml-md-0">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a href="/dashboard" class="dropdown-item d-flex">
              <div class="d-flex align-items-center logout">
                ...
                <form action="/dashboard" class="m-0">
                  @csrf
                  <button class="border-0 p-0 m-0">Profile</button>
                </form>
              </div>
            </a>
            
            <form method="POST" action="{{ route('logout') }}" class="m-0 dropdown-item d-flex logout" id="form-logout">
              @csrf
              <div class="d-flex align-items-center logout">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                  ...
                  <path
                    ...
                    fill="black" />
                  <path d="M16.09 15.59L17.5 17L22.5 12L17.5 7L16.09 8.41L18.67 11H9V13H18.67L16.09 15.59Z"
                    fill="black" />
                </svg>
                <button type="submit" class="border-0 p-0 m-0">Logout</button>
              </div>
            </form>
          </div>
        </li>
