<nav class="bg-white navbar fixed-top navbar-expand-lg ">
  <div class="container w-100 bg-white contain-nav">
    ...
    <div class="collapse navbar-collapse w-75" id="navbarTogglerDemo02">
      <div class="d-lg-flex justify-content-between d-sm-block w-100 ">
        <ul class="navbar-nav mb-3 mb-lg-0 justify-content-center ">
          <li class="nav-item">
