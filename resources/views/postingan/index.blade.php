...
@section('content')
  ...
  <div class="container">
    <div class="list-postingan">
      ...
      <div class="wrap-post">
        @if ($item['active_nonactive'] == 0)
        <div class="text-nonactive w-full h-full d-flex justify-content-center align-items-center">
                ...
                <div class="container p-0 detail-content-postingan">
                  <div class="box-postingan">
                    <div class="flex align-items-center">
                      ...
                      <a href="/postingan/{{ $item['id_postingan'] }}/edit" class="m-0">
                        <p class="m-0">Edit Postingan</p>
                      </a>
                    </div>
                    <div class="flex">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
